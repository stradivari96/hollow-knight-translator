...
const Layout = ({ children, page, setPage, darkMode, toggleDarkMode }) => {
  const title = "Hollow Knight Translator";
  return (
    <div className="bg-gray-200 dark:bg-gray-900 dark:text-gray-100 h-full min-h-screen flex flex-col">
      ...
      >
        <div className="h-20 m-auto font-light text-2xl sm:text-3xl whitespace-no-wrap py-3 flex items-center justify-between">
          <h1 style={{ margin: 0 }}>
            <a
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-xl leading-none p-1 rounded hover:opacity-70 transition-opacity cursor-pointer"
      ...
      <footer className="flex my-4">
        <p className="m-auto font-light dark:text-gray-300">
          <a
            className="inline-block align-middle dark:text-gray-300"
